...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 120;
  ...
  public void robotInit() {
    ...
    WPI_TalonSRX rightSlave0 = new WPI_TalonSRX(6);
    ...
    leftMaster.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder,
                                                PIDIDX, 10);
    leftEncoderPosition = ()
        -> leftEncoder.getDistance() * encoderConstant;
    leftEncoderRate = ()
        -> leftEncoder.getRate() * encoderConstant *
               10;

    rightMaster.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder,
                                                 PIDIDX, 10);
    rightEncoderPosition = ()
        -> rightEncoder.getDistance() * encoderConstant;
    rightEncoderRate = ()
        -> rightEncoder.getRate() * encoderConstant *
               10;
